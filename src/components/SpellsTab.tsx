...
export const SpellsTab: React.FC<SpellsTabProps> = (props) => {
  ...
  const supplementalSpellsData = props.supplementalSpellsData ?? gameData.supplementalSpellsData;
  ...
  if (spellsData.length === 0 && gameData.secondaryLoading) {
