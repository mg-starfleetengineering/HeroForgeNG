...
const FeatTreeModal = React.lazy(() => import('./FeatTreeModal').then(m => ({ default: m.FeatTreeModal })));
...
export const FeatsTab: React.FC<FeatsTabProps> = (props) => {
  ...
  const featsData = props.featsData ?? gameData.featsData;
  ...
  if (featsData.length === 0 && gameData.secondaryLoading) {
