...
| `wondrous_items.json` | 1,059 Predefined Wondrous Items | `id`, `name`, `slot`, `effect`, `cost`, `weight`, `source`, `category` |
| `tables.json` | Core D&D 3.5e Reference Tables | Carrying capacity, XP thresholds, class progression tables, high ability bonus spells |
